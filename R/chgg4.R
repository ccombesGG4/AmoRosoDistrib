...
#
#############################################################################
###' GG4 Cumulative Hazard Function
###
#
#' @description GG4 CHF: Cumulative hazard function of the four-parameter Generalized gamma distribution
#' @param x data
#' @param a scale parameter
#' @param l shape parameter
#' @param c power shape parameter
#' @param mu location parameter
#' @return Cumulative hazard ratio
#'
#'
#' @examples
...
#' ## 0.00995 0.29432  0.69320   0.97773 1.36683  4.61512
#'
#' @seealso \code{\link{dgg4}},  \code{\link{pgg4}}, \code{\link{qgg4}}, \code{\link{rgg4}},\code{\link{hgg4}}
#'
#'
#' @export
#'
chgg4 <- function(x,a,l,c,mu = 0)
{
  ...
  -log(pgg4(q=x, a=a, l=l, c=c, mu=mu, lower.tail=FALSE))
}
